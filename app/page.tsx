        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="overflow-hidden rounded-xl bg-white shadow-lg" data-aos="fade-left">
              ...
              <div className="p-6">
                <p className="text-sm font-semibold uppercase tracking-wider text-orange-600">Active Project</p>
                <h3 className="mt-2 text-2xl font-bold text-gray-900">INTRAMS 2026</h3>
                <p className="mt-2 text-sm">Online Tabulation System</p>
                <p className="mt-3 text-sm text-gray-600">
                  Real-time scoring and tabulation for Mr. & Miss Intrams. Features include judge portals, live leaderboard, and automatic computation.
                </p>
                <Link href="/intrams" className="mt-4 inline-block rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-orange-700">
                  Visit INTRAMS 2026
                </Link>
              </div>
            </div>
