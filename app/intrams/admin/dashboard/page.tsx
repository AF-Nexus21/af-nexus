...
export default function AdminDashboard() {
  ...
  async function handleDeleteCandidate(candidate: any) {
    const confirmDelete = await window.confirm(
      `Are you sure you want to delete candidate #${candidate.number} - ${candidate.name}? This will also delete all scores associated with this candidate.`
    );
                      ...
                      <tr key={candidate.id} className="border-b">
                        ...
                        <td className="px-4 py-2">
                          <button
                            ...
                            disabled={loading}
                            className="bg-red-600 text-white px-3 py-1 rounded-lg text-sm font-semibold hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            Delete
                          </button>
                        </td>
